...
$_['text_paygine_e']			= '<a onclick="window.open(\'http://www.paygine.net/\');"><img src="view/image/payment/paygine.png" alt="Paygine" title="Paygine" style="border: 1px solid #EEEEEE;" /><br /></a>';
